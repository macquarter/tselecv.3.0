    ...
    <div className="bg-black min-h-screen text-white selection:bg-white/30 selection:text-white">
      ...
      <main className="pt-32 pb-20">
        ...
        <section className="relative flex flex-col items-center justify-center text-center px-6 mb-32">
          ...
          >
            <EditableText id="others_badge" defaultText="Other Solutions" />
          </motion.div>
          <motion.h1 
          ...
          >
            <EditableText id="others_title1" defaultText="한계를 넘어서는" /><br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-gray-200 to-gray-600">
              <EditableText id="others_title2" defaultText="산업용 제어 솔루션." />
            </span>
          </motion.h1>
          <motion.p 
          ...
          >
            <EditableText id="others_desc1" defaultText="정밀 온도 제어부터 특수 산업 장비까지," /><br className="hidden md:block" />
            <EditableText id="others_desc2" defaultText="태승전자의 혁신적인 기술력을 경험하세요." />
          </motion.p>
        </section>
        ...
        <section className="max-w-7xl mx-auto px-6 mb-32">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center mb-32">
            ...
            >
              ...
              <EditableImage 
                id="others_img"
                defaultSrc="https://images.unsplash.com/photo-1581092335397-9583eb92d232?auto=format&fit=crop&w=800&q=80" 
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold mb-6 tracking-tight">
                <EditableText id="others_content_title" defaultText="정밀 온도 제어." />
              </h2>
              <p className="text-gray-400 text-lg leading-relaxed mb-12 font-light">
                <EditableText id="others_content_desc" defaultText="Electro Steel 컨트롤러는 산업용 가열 및 냉각 시스템의 정밀한 온도 제어를 담당합니다. 고급 센서 기술과 알고리즘을 통해 안정적인 온도 유지를 보장합니다." />
              </p>
                ...
                <div className="divide-y divide-white/5">
                  {specs.map((spec, i) => (
                    <div key={i} className="flex justify-between p-5 hover:bg-white/5 transition-colors">
                      <strong className="text-white font-medium tracking-tight">
                        <EditableText id={`others_spec_label_${i}`} defaultText={spec.label} />
                      </strong>
                      <span className="text-gray-400 font-light">
                        <EditableText id={`others_spec_val_${i}`} defaultText={spec.value} />
                      </span>
                    </div>
                  ))}
                </div>
          ...
          >
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold mb-4">
                <EditableText id="others_apps_title" defaultText="다양한 산업 적용 사례" />
              </h2>
              <p className="text-gray-400 font-light">
                <EditableText id="others_apps_desc" defaultText="다양한 분야에서 활용되는 태승전자의 기술력을 확인하세요." />
              </p>
            </div>
              ...
              {apps.map((app, i) => (
                ...
                >
                  <div className="w-12 h-12 rounded-full bg-red-600 flex items-center justify-center text-white font-bold text-xl mb-6 font-orbitron">
                    <EditableText id={`others_app_num_${i}`} defaultText={app.num} />
                  </div>
                  <h3 className="text-xl font-bold mb-4">
                    <EditableText id={`others_app_title_${i}`} defaultText={app.title} />
                  </h3>
                  <p className="text-gray-400 text-sm leading-relaxed">
                    <EditableText id={`others_app_desc_${i}`} defaultText={app.desc} />
                  </p>
                </motion.div>
              ))}
            </div>
