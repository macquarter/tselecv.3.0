    ...
    <section ref={containerRef} className="h-[150vh] relative bg-black">
      <div className="sticky top-0 h-screen overflow-hidden flex items-center justify-center">
        ...
        >
          <EditableImage 
            id="hero-bg-image"
            defaultSrc="https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&w=2500&q=80"
            alt="Circuit Board"
            className="w-full h-full object-cover"
          />
          <div className="absolute inset-0 bg-gradient-to-b from-black/20 via-black/80 to-black pointer-events-none"></div>
        </motion.div>
        ...
        >
          ...
          >
            <EditableText id="hero-badge" defaultText="Since 1989" />
          </motion.div>
          ...
          >
            <EditableText id="hero-title-1" defaultText="정밀한 제어," /> <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-indigo-400 to-purple-400 drop-shadow-[0_0_25px_rgba(129,140,248,0.4)]">
              <EditableText id="hero-title-2" defaultText="무한한 가능성" />
            </span>
          </motion.h1>
          ...
          >
            <EditableText 
              id="hero-subtitle" 
              defaultText="마이크로컨트롤러 설계부터 제조까지,\n태승일렉이 혁신적인 자동화 솔루션의 기준을 제시합니다." 
              multiline 
            />
          </motion.p>
        </motion.div>
        ...
        >
          <span className="text-[10px] font-bold tracking-[0.3em] text-gray-500 uppercase">
            <EditableText id="hero-scroll-text" defaultText="Scroll to explore" />
          </span>
          <motion.div 
